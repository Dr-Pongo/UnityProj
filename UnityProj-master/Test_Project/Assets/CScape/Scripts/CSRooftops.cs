...
namespace CScape
{
   ...
   //     private Bounds greebleArea;
        ...
        public void MergeMeshes()
        {
            ...
            //{
            //    Mesh meshOriginal = meshFilters[i].sharedMesh;
            //    Vector3[] originalVertices = meshOriginal.vertices;
            //    Vector2[] originalUVs = meshOriginal.uv;
            //    Mesh mesh = Instantiate(meshOriginal) as Mesh;
            //    MeshFilter meshFilter = GetComponent<MeshFilter>();
            //    meshFilters[i].sharedMesh = mesh;
            //    Vector2[] meshColors = meshFilters[i].mesh.uv;
            //    for (int v = 0; v < meshColors.Length; v++)
            //    {
            //        mesh.uv3[v] = new Vector2(0, 0.5f);
            //    }
