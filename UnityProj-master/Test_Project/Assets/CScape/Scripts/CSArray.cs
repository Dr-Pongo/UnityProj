                        ...
                        //    greebleAreaZ = new Bounds(maxZ - rooftopHolder[i].transform.position, new Vector3(500, 200, 0.2f));
                            ...
                            for (int j = 0; j < Mathf.FloorToInt((buildingWidth - rightSideStart[i]) / skipX[i]); j++)
                            {
                                for (int k = 0; k < Mathf.FloorToInt((floorNumber - upStart[i]) / skipY[i]); k++)
                                {
                                    ...
                                    {
                                        newObject.transform.position = new Vector3(leftSideStart[i] * 3 + rooftopHolder[iteration].transform.position.x + j * skipX[i] * 3, downStart[i] * 3 + minLineX.y + k * skipY[i] * 3, minLineX.z) - rooftopHolder[iteration].transform.position;
                            ...
                            {
                                rooftopHolder[iteration].transform.Rotate(0, 0, 180);
